      ...
      >
        ...
        >
          <Box sx={{ display: "flex", alignItems: "center" }}>
            <HighlightIcon
              sx={{ mr: 1.5, color: "secondary.main", fontSize: 24 }}
            />
          ...
          <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
            ...
            >
              ...
              <Select
                ...
                startAdornment={
                  <LanguageIcon sx={{ mr: 0.5, color: "action.active" }} />
                }
                disabled={listening}
              >
            ...
            <Tooltip title="Share Transcript">
              <span>
                <IconButton
                  onClick={handleShare}
                  disabled={!transcript || listening || !navigator.share}
                  size="small"
                >
                  <ShareIcon />
                </IconButton>
        ...
        >
          {!speechRecognitionSupported ? (
            ...
            <Alert severity="error" icon={<MicOffIcon />}>
              Microphone access denied or not found.
            </Alert>
          ) : listening ? (
            <>
              <HighlightKeywords
